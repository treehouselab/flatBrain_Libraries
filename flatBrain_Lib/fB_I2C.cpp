...
uint8_t  fB_I2C::bytesAvailable = 0;
uint8_t  fB_I2C::bufferIndex = 0;
uint8_t  fB_I2C::totalBytes = 0;
uint16_t fB_I2C::timeOutDelay = 0;
...
/*
uint8_t  fB_I2C::write(uint8_t  address, uint8_t  registerAddress)
{
  returnStatus = 0;
  returnStatus = start();
...
uint8_t  fB_I2C::write(int address, int registerAddress)
{
...
uint8_t  fB_I2C::write(uint8_t  address, uint8_t  registerAddress, char *data)
{
...
uint8_t  fB_I2C::write(uint8_t  address, uint8_t  registerAddress, uint8_t  *data, uint8_t  numberBytes)
{
  returnStatus = 0;
  returnStatus = start();
  if(returnStatus){return(returnStatus);}
...
uint8_t  fB_I2C::write(uint8_t  address, uint8_t  registerAddress1,uint8_t  registerAddress2, uint8_t  *data, uint8_t  numberBytes)
{
  returnStatus = 0;
  returnStatus = start();
  if(returnStatus){return(returnStatus);}
  ...
  returnStatus = sendByte(registerAddress1);
  if(returnStatus)
  {
    if(returnStatus == 1){return(3);}
    return(returnStatus);
...
uint8_t  fB_I2C::read(int address, int numberBytes)
{
  return(read((uint8_t ) address, (uint8_t ) numberBytes));
}

uint8_t  fB_I2C::read(uint8_t  address, uint8_t  numberBytes)
{
  bytesAvailable = 0;
  bufferIndex = 0;
...
uint8_t  fB_I2C::read(int address, int registerAddress, int numberBytes)
{
  return(read((uint8_t ) address, (uint8_t ) registerAddress, (uint8_t ) numberBytes));
}

uint8_t  fB_I2C::read(uint8_t  address, uint8_t  registerAddress, uint8_t  numberBytes)
{
  bytesAvailable = 0;
  bufferIndex = 0;
  if(numberBytes == 0){numberBytes++;}
...
uint8_t  fB_I2C::sendByte(uint8_t  i2cData)
{
  TWDR = i2cData;
  unsigned long startingTime = millis();
  TWCR = (1<<TWINT) | (1<<TWEN);
...
uint8_t  fB_I2C::receiveByte(uint8_t  ack)
{
  unsigned long startingTime = millis();
  if(ack)
  {
